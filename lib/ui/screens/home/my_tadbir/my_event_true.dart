...
class MyEventsTrue extends StatefulWidget {
  const MyEventsTrue({super.key});

  @override
  State<MyEventsTrue> createState() => _MyEventsTrueState();
}

class _MyEventsTrueState extends State<MyEventsTrue> {
  List<EventModel> lst = [];
